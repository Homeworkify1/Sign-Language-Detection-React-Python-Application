        ...
        <MainContainer>
            ...
            <SectionBackground $bgColor="var(--background-1)">
                <SectionContainer $padSize="4rem">
                    <TitleContainer>
                        <h1> Zaibten <br/> Sign Language </h1> 
                        <h2> Fluent Fingers, Open Minds</h2>
                        <h3>Welcome to Zaibten Sign Language, where we believe that communication should have no barriers.
            ...
            <SectionBackground $bgColor="var(--background-2)">
                <SectionContainer $flexDir="column" $gapSize="2rem" $padSize="4rem">
                    <h2 style={{ margin: "0" }}>Why Choose Zaibten Sign Language?</h2>
                    <CardsContainer>
