...
export default function ContactPage ({URL}) {
    ...
    const faqs = [
        ...
        {
            question: "Can I use Zaibten Sign Language offline?",
            answer: "Currently, Zaibten Sign Language requires an internet connection to process sign language recognition."
        },
        {
